...
function Cart() {
   ...
   const { backendUrl,navigate,user,products,currency,cartItems,setCartItems,updateCartItem,removeCartItem
    ,getCartCount,getCartAmount} = useAppContext();  
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select className='outline-none' value={cartItems[product._id]}
