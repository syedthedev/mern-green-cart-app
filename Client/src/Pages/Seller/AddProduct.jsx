...
function AddProduct() {
  ...
  return (
        <div className="no-scrollbar flex-1 flex flex-col justify-between h-[95vh]">
            <form onSubmit={(e) => handleSubmit(e)} className="md:p-10 p-4 space-y-5 max-w-lg">
                <div>
                ...
                <button className="px-8 cursor-pointer py-2.5 bg-primary text-white font-medium rounded">ADD</button>
            </form>
        </div>
    );
};
